...
class AssetTransfer extends Contract {
    ...
    // CreateAsset issues a new asset to the assetCollection.
    async CreateAsset(ctx) {
        ...
        // [Nicola]: see that this method directly returns a serialized JSON
        ...
        // [Nicola]: this will be adapted to our use case to prevent Patients 
        // requesting the AssignDrug transaction
